      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">หมู่บ้านที่ไม่ใช้งาน</h1>
          </div>
          <p className="text-muted-foreground">
            รายการหมู่บ้านที่ถูกปิดใช้งานในระบบ
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            รายการหมู่บ้านที่ไม่ใช้งาน ({villages.length})
          </CardTitle>
          <CardDescription>
            หมู่บ้านที่ถูกปิดใช้งานและวันที่ปิดใช้งาน
          </CardDescription>
        </CardHeader>
        <CardContent>
          {villages.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">ไม่มีหมู่บ้านที่ไม่ใช้งานในระบบ</p>
              <Link href="/super-admin-dashboard/villages">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>วันที่ปิดใช้งาน</TableHead>
      ...
      <Dialog open={isRestoreDialogOpen} onOpenChange={setIsRestoreDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              คุณแน่ใจหรือไม่ที่จะคืนสถานะหมู่บ้าน "{selectedVillage?.village_name}" ให้เป็นใช้งานได้อีกครั้ง?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
