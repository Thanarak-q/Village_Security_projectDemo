...
/**
 * @file This file provides a slider component.
 *
 * The `Slider` component allows users to select a value or a range of values
 * from a specified range. It is built on top of the Radix UI Slider primitive.
 */
