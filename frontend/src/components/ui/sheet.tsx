/**
 * @file This file provides a set of components for creating sheet-style side panels.
 *
 * Built on Radix UI's Dialog primitive, these components are designed to create
 * overlays that slide in from the edge of the screen, commonly used for navigation
 * menus, forms, or other supplementary content.
 */
...
/**
 * A semi-transparent overlay that covers the main content when the sheet is open.
 *
 * @param {React.ComponentProps<typeof SheetPrimitive.Overlay>} props - The props for the component.
 * @returns {React.ReactElement} The sheet overlay element.
 */
 ...
 * @returns {React.ReactElement} The sheet content container.
 */
 ...
 * @returns {React.ReactElement} The sheet header element.
 */
 ...
 *
 * @param {React.ComponentProps<"div">} props - The props for the component.
 * @returns {React.ReactElement} The sheet footer element.
 */
 ...
 * @returns {React.ReactElement} The sheet title element.
 */
 ...
 * @returns {React.ReactElement} The sheet description element.
 */
