/**
 * @file This file provides a set of components for creating navigation menus.
 *
 * Built on Radix UI's Navigation Menu primitive, these components are fully accessible
 * and provide a way to create a horizontal menu with dropdowns for site navigation.
 */
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ...
    {...props}
  >
    {children} <ChevronDownIcon className="relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" aria-hidden="true" />
  </NavigationMenuPrimitive.Trigger>
));
