...
export const villages = pgTable("villages", {
  ...
  status: text("status").$type<"active" | "disable">().default("active"),
 ...
 */
export const admin_villages = pgTable(
  "admin_villages",
  {
  ...
  (table) => [
    ...
    index("idx_admin_villages_admin_village_id").on(
      table.admin_id,
      table.village_id
    ),
  ]
 ...
 */
export const house_members = pgTable(
  "house_members",
  {
 ...
 */
export const visitor_records = pgTable(
  "visitor_records",
  {
  ...
  (table) => [
    ...
    index("idx_visitor_records_status_created_at").on(
      table.record_status,
      table.createdAt
    ),
...
export const visitors = pgTable(
  "visitors",
  {
    ...
    id_doc_type: text("id_doc_type").$type<
