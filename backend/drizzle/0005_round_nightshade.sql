...
ALTER TABLE "admin_notifications" ADD CONSTRAINT "admin_notifications_admin_id_admins_admin_id_fk" FOREIGN KEY ("admin_id") REFERENCES "public"."admins"("admin_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_admin_notifications_admin_id_is_read" ON "admin_notifications" USING btree ("admin_id","is_read");--> statement-breakpoint
